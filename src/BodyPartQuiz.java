...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if(i==0) {
			if(guess.equalsIgnoreCase("Donald Trump")) {
			score=score+1;
			JOptionPane.showMessageDialog(null, "You are correct.");
			}else {JOptionPane.showMessageDialog(null, "You are wrong. This person is Donald Trump.");}
			showNextImage();
			JOptionPane.showMessageDialog(null, "You score is "+score);
			} else if(i==1) {
				if(guess.equalsIgnoreCase("Van Darkholme")) {
					score=score+1;
					JOptionPane.showMessageDialog(null, "You are correct.");
					}else {JOptionPane.showMessageDialog(null, "You are wrong. This person is Van Darkholme.");}
					showNextImage();
					JOptionPane.showMessageDialog(null, "You score is "+score);
			}else if(i==2) {
				if(guess.equalsIgnoreCase("Billy Herrington")) {
					score=score+1;
					JOptionPane.showMessageDialog(null, "You are correct.");
					}else {JOptionPane.showMessageDialog(null, "You are wrong. This person is Billy Herrington.");}
					showNextImage();
					JOptionPane.showMessageDialog(null, "You score is "+score);
			}else if(i==3) {
				if(guess.equalsIgnoreCase("Muji Kazuya")) {
					score=score+1;
					JOptionPane.showMessageDialog(null, "You are correct.");
					}else {JOptionPane.showMessageDialog(null, "You are wrong. This person is Muji Kazuya.");}
					showNextImage();
					JOptionPane.showMessageDialog(null, "You score is "+score);
			}
